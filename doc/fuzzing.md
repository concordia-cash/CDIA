Fuzz-testing Concordia Cash Core
==========================
...
To build Concordia Cash Core using AFL instrumentation (this assumes that the
...
with certain assembly code from Concordia Cash Core's code. See [developer notes on sanitizers](https://github.com/concordia-cash/CDIA/blob/master/doc/developer-notes.md#sanitizers)
