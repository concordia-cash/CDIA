...
This document provides guidelines for internationalization of the Concordia Cash Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Concordia Cash network</source>
        <translation>
            <numerusform>%n active connection to Concordia Cash network</numerusform>
            <numerusform>%n active connections to Concordia Cash network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `concordia_en.ts` remains unchanged.
