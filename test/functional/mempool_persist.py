...
By default, concordiad will dump mempool on shutdown and
...
class MempoolPersistTest(ConcordiaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent concordiad from writing mempool.dat to disk. Verify that `savemempool` fails")
