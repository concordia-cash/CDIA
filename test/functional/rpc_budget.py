...
class BudgetProposalTest(ConcordiaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Concordia Cash address")
        assert_raises_rpc_error(-5, "Invalid Concordia Cash address", self.nodes[0].preparebudget,
