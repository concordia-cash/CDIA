...
public:
    ...
    /**
     * Amount of concordia coming in to a transaction
...
// Concordia Cash: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
