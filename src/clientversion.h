...
#error Client version information missing: version is not defined by concordia-config.h or in any other way
#endif
...
/**
 * concordiad-res.rc includes this file, but it cannot cope with real c++ code.
