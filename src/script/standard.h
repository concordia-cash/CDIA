 ...
 *  A CTxDestination is the internal data type encoded in a Concordia Cash address
 */
...
/**
 * Generate a Concordia Cash scriptPubKey for the given CTxDestination. Returns a P2PKH
