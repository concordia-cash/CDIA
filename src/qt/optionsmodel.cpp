...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeConcordiaAmount") || reset)
        gArgs.SoftSetArg("-anonymizeconcordiaamount", settings.value("nAnonymizeConcordiaAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in concordia.cpp during shutdown to also remove the window positions
