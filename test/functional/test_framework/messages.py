...
# Objects that map to concordiad objects, which can be serialized/deserialized
class CAddress:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in concordiad indicates these should be deserialized as blocks
