...
This means one can have an always-on concordiad instance running, and another local concordiad/concordia-qt instance which connects to this node and receives blocks from it.
