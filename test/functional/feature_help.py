...
"""Verify that starting concordia with -h works as expected."""
...
class HelpTest(ConcordiaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start concordia with -? for help text")
        ...
        self.log.info("Start concordia with -version for version information")
