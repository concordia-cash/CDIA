...
from test_framework.test_framework import ConcordiaTestFramework, SkipTest
...
class ZMQTest (ConcordiaTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that concordia has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("concordiad has not been built with zmq enabled.")
