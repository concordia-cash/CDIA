Contributing to Concordia Cash Core
============================

The Concordia Cash Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/concordia-cash/CDIA/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Concordia Cash Core project, and is not to be
confused with overall Concordia Cash Network Protocol consensus changes.

Whether a pull request is merged into Concordia Cash Core rests with the project merge
...
Patches that change Concordia Cash consensus rules are considerably more involved than
...
Where a patchset proposes to change the Concordia Cash consensus, it must have been
...
The project leader is the release manager for each Concordia Cash Core release.
