...
class FullBlockTest(ConcordiaTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure concordiad isn't accepting b26
        ...
        # Extend the b28 chain to make sure concordiad isn't accepting b28
        ...
        #    Low-S and High-S values (whereas the concordia code has custom code which does so);
