UNIX BUILD NOTES
====================
Some notes on how to build Concordia Cash Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile Concordia Cash Core and the dependencies,
...
memory available when compiling Concordia Cash Core. On systems with less, gcc can be
...
To build Concordia Cash Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your Concordia Cash Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Concordia Cash Core should be built with a non-executable stack
...
When the intention is to run only a P2P node without a wallet, Concordia Cash Core may be compiled in
